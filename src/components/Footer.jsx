...
import corazon from "../static/images/heart-regular.svg";
import marcador from "../static/images/map-marker-alt-solid.svg";
import carta from "../static/images/envelope-regular.svg";
import logoCTIC from "../static/images/ctic_oficial.png";
...
const Icono = ({ texto, icono, url }) => (
  ...
  >
    <img
      src={require(`../static/images/${icono}-brands.svg`)}
      alt={`icono ${icono}`}
